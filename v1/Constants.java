...
public class Constants {
	...
	final static String HANDOVER_REQUEST = "24";
	final static String HANDOVER_ACCEPT = "25";
	final static String PERFORM_HANDOVER = "26";
	final static String HANDOVER_COMPLETE = "27";
